...
//import HTMLElement from "jquery";
...
let printthis = document.querySelector("#print-this") as HTMLElement
...
let username = document.getElementById("username") as HTMLInputElement
    ...
    shareBtn.addEventListener("click", async () => {
        try {
            const shareableLink = `https://milestone-4-editable-resume-pi.vercel.app///?username.value/${username.value.replace(/\s+/g, '_')}`
